...
features:
  ...
  - icon: |-
    ...
    details: 使用 `.value` 数据和原始数据进行包装。Uses `.value` to wrap data and original data. State management is simpler and more intuitive, avoiding many common ambiguity traps.
  - icon: |-
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
  ...
  - icon: |-
    ...
    title: Flexible API
    details: Adopts a composable API design with a minimized API interface. Can be composed into any form you want.可组合出你想要的任何形态。
  - icon: |-
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
  ...
  - icon: |-
    ...
    details: 作用可进行范围收集。Scope can be used for range collection. Additionally, low-level APIs are exposed for deep customization
---
